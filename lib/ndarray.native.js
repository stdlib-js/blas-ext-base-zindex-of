...
*
* var idx = zindexOf( x.length, new Complex128( 3.0, 4.0 ), x, 1, 0 );
* // returns 1
*/
function zindexOf( N, searchElement, x, strideX, offsetX ) {
	var view = reinterpret( x, 0 );
	return addon.ndarray( N, searchElement, view, strideX, offsetX );
}
